...
--
-- Host: 127.0.0.1
-- Generation Time: 21-Ago-2018 às 21:42
...
(4, 15, 'oi', 1, '2018-08-10 17:51:48'),
(15, 4, 'oi, tudo bem?', 2, '2018-08-10 17:51:48');
...
ALTER TABLE `den_chat`
  ...
  ADD KEY `cod_usuario` (`usuario_cod_usuario`),
...
--
ALTER TABLE `conversa`
  MODIFY `cod_mensagem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `postagens_forum`
--
ALTER TABLE `postagens_forum`
  MODIFY `cod_postagem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `den_chat`
  ADD CONSTRAINT `den_chat_ibfk_1` FOREIGN KEY (`usuario_cod_usuario`) REFERENCES `usuario` (`cod_usuario`),
...
ALTER TABLE `den_coment`
  ...
  ADD CONSTRAINT `den_coment_ibfk_2` FOREIGN KEY (`usuario_cod_usuario`) REFERENCES `usuario` (`cod_usuario`);
...
ALTER TABLE `den_forum`
  ...
  ADD CONSTRAINT `den_forum_ibfk_2` FOREIGN KEY (`usuario_cod_usuario`) REFERENCES `usuario` (`cod_usuario`);
COMMIT;
