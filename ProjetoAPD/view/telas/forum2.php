    ...
    <script>
        $(document)
            .ready(function () {
                ...
                $(".denPostButton").click(function() {
                    $('.denPostModal')
                        .modal('show');
                });


                $("#denComButtom").click(function(){
                    $("#denComModal")
                        .modal('show');
                });
            ...
            <div class="comment" id="post">
                ...
                <div class="content">
                    ...
                    <div class="metadata">
                        ...
                        <?php if (isset($_SESSION['logado'])) { ?>
                            <button class="mini ui  negative basic button denPostButton">
                    ...
                    <?php if (isset($_SESSION['logado'])) {  ?>
                        ...
                        <div class="ui fullscreen modal transition denPostModal" id="">
                            <div class="header">
                    ...
                    <div class="ui container segment comments" id="comment">
                        <div class="comment">
                            ...
                            <div class="content">
                                ...
                                <?php if (isset($_SESSION['logado'])) { ?>
                                    <button class="mini ui  negative basic button" id="denComButtom">
                                        <i class="remove icon"></i>
                                        denunciar
                                    </button>
                                <?php } ?>
                                ...
                                <?php if (isset($_SESSION['logado'])) {  ?>
                                    ...
                                    <div class="ui fullscreen modal transition" id="denComModal">
                                        <div class="header">
